    ...
    return (
        ...
        >
            <button
                id={faq.id}
                onClick={onToggle}
                className="w-full flex items-center justify-between gap-4 p-5 text-left bg-white/[0.02] hover:bg-white/[0.04] transition-colors"
            ...
            >
                ...
                <ChevronDown
                    className={`w-5 h-5 shrink-0 text-cyan-400 transition-transform duration-200 ${
                        isOpen ? "rotate-180" : ""
                    }`}
                />
            </button>
